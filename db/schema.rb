...
ActiveRecord::Schema[7.1].define(version: 2024_05_08_122158) do
  ...
  create_table "book_tags_books", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "film_tags_films", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
